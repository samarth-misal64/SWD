...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"evo-calender.min.js":[function(require,module,exports) {
var define;
...
!function (e) {
  ...
  i = 0, (r = function r(e, t) {
    ...
    if (a.defaults = {
      ...
      dates: {
        en: {
          ...
          noEventForToday: "There is no event today, so take a break!",
          noEventForThisDay: "There is no event today, so take a break!",
    ...
    }, null != a.options.calendarEvents) for (var n = 0; n < a.options.calendarEvents.length; n++) {
    ...
    if (e instanceof Array) {
      if (t.everyYear) for (var r = 0; r < e.length; r++) {
        e[r] = i.formatDate(new Date(e[r]).setFullYear(i.$active.year), i.options.format);
      }
    ...
    function t(t) {
      if (t.id || console.log('%c Event named: "' + t.name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), t.date instanceof Array) for (var e = 0; e < t.date.length; e++) {
    ...
    if (e instanceof Array) for (var a = 0; a < e.length; a++) {
      t(e[a]);
    } else "object" == _typeof(e) && t(e);
  }, r.prototype.removeCalendarEvent = function (e) {
    var n = this;

    function t(e) {
      var t,
          a = n.options.calendarEvents.map(function (e) {
        return e.id;
      }).indexOf(e);
    ...
    for (var e, t = this, a = arguments[0], n = Array.prototype.slice.call(arguments, 1), i = t.length, o = 0; o < i; o++) {
      if ("object" == _typeof(a) || void 0 === a ? t[o].evoCalendar = new r(t[o], a) : e = t[o].evoCalendar[a].apply(t[o].evoCalendar, n), void 0 !== e) return e;
    }
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","evo-calender.min.js"], null)
//# sourceMappingURL=/evo-calender.min.97a85aa2.js.map