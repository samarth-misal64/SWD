...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 " style="z-index: 2; padding-left:5%;">
        <div class="flip-card">
          <div class="flip-card-inner" id="form1">
            <div class="flip-card-front">

              <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" myForm="text-center" id="form" class="row g-3" autocomplete="off">
                ...
                <div class="col-md-6">
                  ...
                  <select name="isStud" class="form-select" required>
                ...
                <div class="col-md-6">
                  ...
                  <input type="randomtext" class="form-control" name="Organization" required>
                </div>


                <div class="col-12">
                  <label for="inputText" class="form-label">Is there anything else you would like us to know?</label>
                  <input type="text" class="form-control" name="randomText">
                </div>

                <div class="col-md-12">
                  <label for="inputReferral" class="form-label">How did you hear about Aatmabodh?</label>
                ...
                <div class="form-group form-check">
                    ...
                    <label class="form-check-label" for="exampleCheck1">I have read and understood all the <a href="https://docs.google.com/document/d/19XokwBD_lekNqC2MgZAeDxIFeles0RqwxvXA2WyfOVc">guidelines</a></label>
                </div>
                ...
                <div class="text-center">
                  <button type="submit" name="nonvitsubmit" class="button" value="Disabled" disabled>SUBMIT</button>
                </div>
              </form>
            ...
            <div class="flip-card-back">
              ...
              <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" myForm="text-center" id="form" class="row g-3">
                ...
                <div class="text-center">
                  <button type="submit" name="vitsubmit" class="button" value="Disabled" disabled>SUBMIT</button>
                </div>
              </form>
